...
//               Home
//             </Link>
//             <Link to="/products" className="text-gray-300 hover:text-red-600">
//               Shop
//             </Link>
...
//               <Link to="/" className="block px-4 py-3 text-base font-medium text-gray-200 hover:text-white hover:bg-gray-700 rounded-lg transition-colors duration-150 ease-in-out">
//                 🏠 Home
//               </Link>
//               <Link to="/products" className="block px-4 py-3 text-base font-medium text-gray-200 hover:text-white hover:bg-gray-700 rounded-lg transition-colors duration-150 ease-in-out">
//                 🛍️ Shop
//               </Link>
//               <a href="#" className="block px-4 py-3 text-base font-medium text-gray-200 hover:text-white hover:bg-gray-700 rounded-lg transition-colors duration-150 ease-in-out">
//                 ℹ️ About
//               </a>
//               <a href="#" className="block px-4 py-3 text-base font-medium text-gray-200 hover:text-white hover:bg-gray-700 rounded-lg transition-colors duration-150 ease-in-out">
//                 📞 Contact
...
//               {/* <button className="flex items-center justify-center w-full px-4 py-3 text-base font-medium text-gray-200 hover:text-white hover:bg-gray-700 rounded-lg transition-colors duration-150 ease-in-out mb-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex space-x-6">
            ...
            <a href="#" className="text-gray-300 hover:text-red-600">About</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-gray-800 border-t border-gray-700 shadow-lg animate-in slide-in-from-top-2 duration-200">
            <nav className="px-4 pt-4 pb-2 space-y-2">
              ...
              <a href="#" className="block px-4 py-3 text-base font-medium text-gray-200 hover:text-white hover:bg-gray-700 rounded-lg transition-colors duration-150 ease-in-out">ℹ️ About</a>
