...
def create_tables(verbose: bool = False):
    ...
    from app.models import (
        User, UserAddress, Product, ProductTag, Discount, DiscountTarget,
        Order, OrderItem, OrderItemDiscount, ProductReview, ProductSale,
        product_tag_map
    )
...
# command to run to create tables:
# python backend/app/core/database.py   or python -m app.core.database
